...
export default function Main() {
  ...
  function ready4Recipe() {
    return (
      <div className="get-recipe-container">
        ...
        <button onClick={adjustState}>{recipeShown ? 'Hide recipe' : 'Get a recipe'}</button>
      </div>
    );
  }
  ...
  return (
    <main>
      ...
      {ingredients.length > 3 ? ready4Recipe() : null}
      {recipeShown ? renderRecipe() : null}
    </main>
  );
}
